...
public class Signup extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("Game_recharge/src/main/webapp/register1.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(firstname.contentEquals("") || lastname.contentEquals(""))
        {
        	...
        	RequestDispatcher dispatcher = request.getRequestDispatcher("Game_recharge/src/main/webapp/register2.jsp");
    		dispatcher.forward(request, response);
        }
	}
}